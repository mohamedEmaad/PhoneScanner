//
//  TextRecongnizerViewController.swift
//  MedicineTracker
//
//  Created by Mohamed Emad on 7/6/20.
...
class TextRecongnizerViewController: UIViewController {
...
extension TextRecongnizerViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
    func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        // To be implemented in the sub
    }
